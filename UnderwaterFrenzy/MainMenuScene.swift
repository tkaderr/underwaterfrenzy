...
class MainMenuScene: SKScene {
    ...
    let startlabel = SKLabelNode(fontNamed: "LemonMilk")
    let jump = true
    ...
    override func didMove(to view: SKView) {
        ...
        let gameName0 = SKLabelNode(fontNamed: "LemonMilk")
        gameName0.text = "Underwater"
        gameName0.fontSize = 150
...
//        let gameName1 = SKLabelNode(fontNamed: "LemonMilk")
//        gameName1.text = "Water"
...
//        self.addChild(gameName1)
        ...
        let gameName2 = SKLabelNode(fontNamed: "LemonMilk")
